...
namespace Game
{
   public static class Engine
   {
      ...
      {
         var stories = new List<StoryStatus>();
         ...
         SequenceObjects[itemName].Traverse((@object) =>
         {
            switch (@object)
            {
               case TextObject textObject:
                  ...
                  break;
               case SubstitutionObject substitutionObject:
                  accumulator += EvaluateLabelListFirst(substitutionObject.Expression.LeftName, substitutionObject.Expression.LeftLabels, new Dictionary<string, string>());
                  break;
               case IfObject ifObject:
